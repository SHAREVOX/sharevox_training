...
class EncoderLayer(nn.Module):
    ...
    Args:
        ...
        feed_forward (nn.Module): Feed-forward module instance.
            ...
            can be used as the argument.
        feed_forward_macaron (nn.Module): Additional feed-forward module instance.
            `PositionwiseFeedForward`, `MultiLayeredConv1d`, or `Conv1dLinear` instance
            can be used as the argument.
    ...
    def forward(
        self,
        x_input: Union[Tuple[Tensor, Tensor], Tensor],
        mask: Optional[Tensor],
        cache: Optional[Tensor] = None,
    ) -> Tuple[Union[Tuple[Tensor, Tensor], Tensor],  Optional[Tensor]]:
