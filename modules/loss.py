...
class FastSpeech2Loss(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            log_pitch_outputs (Tensor): Batch of outputs of pitch predictor (B, T_text, 1).
        ...
        log_pitch_outputs = log_pitch_outputs.squeeze(-1).masked_select(pitch_masks)
        log_pitch_targets = torch.log(pitch_targets.float())
        log_pitch_targets = log_pitch_targets.masked_select(pitch_masks)
        ...
        pitch_loss = self.mse_criterion(log_pitch_outputs, log_pitch_targets)
